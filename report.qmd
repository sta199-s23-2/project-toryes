...
**North Carolina counties where fair market rent increased from 2020 to 2023 [^longnote]**
...
[^longnote]: Source: HUD Fair Market Rent Data. Change in fair market rent is calculated by finding the average percent change of fair market rents from 2020 to 2023 of 0 to 4 bedroom accommodations. 
...
rents |>
  ggplot(aes(y = year, x = fmr, group = year)) +
  geom_violin()
```

**Peaks on violin** represent the mean fair market rents for accommodations from 0 to 4 bedrooms.
